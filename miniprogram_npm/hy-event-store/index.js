...
__DEFINE__(1664334622636, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1664334622637,"./event-store":1664334622638}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1664334622637, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1664334622638, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1664334622637,"./utils":1664334622639}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1664334622639, function(require, module, exports) {
...
return __REQUIRE__(1664334622636);
})()

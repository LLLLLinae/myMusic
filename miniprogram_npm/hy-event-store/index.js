...
__DEFINE__(1664006575760, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1664006575761,"./event-store":1664006575762}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1664006575761, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1664006575762, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1664006575761,"./utils":1664006575763}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1664006575763, function(require, module, exports) {
...
return __REQUIRE__(1664006575760);
})()
